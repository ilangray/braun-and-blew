...
void example(){
    ...
    colorsrr[0] = new Color("RGB", 255,0,0);
    colorsrr[1] = new Color("RGB", 0,255,255);
    colorsrr[2] = new Color("RGB", 255,0,128);
    colorsrr[3] = new Color("RGB", 0,255,0);
    colorsrr[4] = new Color("RGB", 128,0,255);
    colorsrr[5] = new Color("RGB", 255,196,0);
    colorsrr[6] = new Color("RGB", 19,84,3);
    colorsrr[7] = new Color("RGB", 0,0,64);
